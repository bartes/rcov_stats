Gem::Specification.new do |gemspec|
    ...
    gemspec.files = Dir['lib/*.rb'] + Dir['config/*.yml'] +  Dir['templates/*.*'] +  Dir['tasks/*.*'] +  Dir['lib/rcov_stats_related/*.rb'] + Dir['lib/rcov_stats_related/integrations/*.rb']
